...
@section('content')
<div class="row" style="width: 80%; margin-left: auto; margin-right: auto; margin-top: 200px">
    <div class="col s7 push-s6">
        <img src="https://img.cuisineaz.com/660x660/2015-06-02/i87290-cocktail-au-whisky-the-vert-citron-et-menthe.jpg" alt="" style="width: 400px;">
    </div>
...
<div class="row" style="background-color: #b7e4c7; margin-top: 200px;  margin-bottom: 0; padding-top: 50px; padding-bottom: 50px">
...
<div class="row" style="text-align: center; color: white;" id="home-register">
    ...
    <div class="col s6" style="background-color: #40916c; padding: 2em">

        <img src="https://www.thespruceeats.com/thmb/721kkzdDKgQ4FnJpdCaXVgwttUI=/1816x1362/smart/filters:no_upscale()/easy-fresh-mint-tea-recipe-766391-6_preview-5b291f95ba61770036733329.jpeg" style="height: 400px">
        <h4>A green and experienced mintor</h4>
